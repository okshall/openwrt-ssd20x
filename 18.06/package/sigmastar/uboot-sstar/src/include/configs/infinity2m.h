...
#define CONFIG_EXTRA_ENV_SETTINGS                              \
       "bootdelay=2\0"                           \
	   "tfupgrade=tftp 0x21000000 NOR-sysupgrade.bin;sf probe 0;sf erase 0x00070000 0x00b90000;sf write 0x21000000 0x00070000 0x00b90000; reset\0" \
	   "tfkernel=tftp 0x21000000 NOR-uImage.bin;sf probe 0;sf erase 0x00070000 0x00290000;sf write 0x21000000 0x00070000 0x00290000;reset \0" \
	   "tfrootfs=tftp 0x21000000 NOR-rootfs.bin;sf probe 0;sf erase 0x00300000 0x00900000;sf write 0x21000000 0x00300000 0x00900000;reset \0" \
	   "tfuboot=tftp 0x21000000 NOR-boot.bin;sf probe 0;sf erase 0x000000 0x0070000;sf write 0x21000000 0x000000 0x0070000;reset \0" \
	   "tfall=tftp 0x21000000 NOR-all.bin;sf probe 0;sf erase 0x000000 0x00d00000;sf write 0x21000000 0x000000 0x0d00000;reset \0" \
	   ""


#define	CONFIG_BOOTARGS	"console=ttyS0,115200 root=/dev/mtdblock2 rootfstype=squashfs ro init=/linuxrc"

#define	CONFIG_BOOTCOMMAND						\
	"mw 1f001cc0 11; "	\
	"sf probe 0; "								\
	"sf read 0x22000000 0x00070000 0x00290000; "			\
	"bootm 0x22000000;"
